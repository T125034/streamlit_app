...
st.write('このデータの期間は1921年から2023年で、年次別にみた出生数・出生率（人口千対）・出生性比及び合計特殊出生率を知ることができます。')
...
st.write('これらの結果から、日本の出生数減少は長期的かつ深刻な傾向であり、出世数の低下が少子高齢化に大きな影響を与えていると考えられる。今後は、子育て支援や働き方改革など、出生率向上に向けた社会的取り組みの重要性が一層高まると考えられる。')